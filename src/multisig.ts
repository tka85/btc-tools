...
// Normal multisig
const P2SH_P2MS_MultisigAddress: MultisigFunc = (threshold: number, publicKeys: Buffer[], network: bitcoinjs.Network): MultisigRecord => {
...
const P2SH_P2WSH_P2MS_MultisigAddress: MultisigFunc = (threshold: number, publicKeys: Buffer[], network: bitcoinjs.Network): MultisigRecord => {
    const res = bitcoinjs.payments.p2sh({
...
const P2WSH_P2MS_MultisigAddress: MultisigFunc = (threshold: number, publicKeys: Buffer[], network: bitcoinjs.Network): MultisigRecord => {
...
const validateParams = (params: MultisigParams) => {
...
export const multisig = ({ multisigType, threshold, extKeys, path, count, pubKeys, output = null, network = 'btc' }: MultisigParams): MultisigRecord[] => {
    ...
    const multisigFunc: MultisigFunc = MULTISIG_FUNCS[multisigType] as MultisigFunc;
